...
3. This third and final part is where I finally roll up my sleeves and review some better ways of approaching agility with value at its core. So this essay forms the basis of a curriculum for aligning digital development agility with value delivery.
...
The fundamental concept of *value* underpins this essay: a word that's prominent in the Manifesto for Agile Software Development, without *actually getting defined anywhere*. Handy, eh?
...
But these last two sections are where I start to fade off into politics, social science, Utopian ideals and visions for a better world. Obviously I won't be able to stop myself from ranting on about all of those things *some day*, but for now, suffice to say that being small-a-agile, genuinely and thoroughly, ought to provide a good practical basis for making the world a much better place, if we all finally learn to do it properly.
